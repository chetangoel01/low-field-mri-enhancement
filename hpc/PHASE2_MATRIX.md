...
6. `unet_se_r1`
- Script: `hpc/train_job.sbatch`
- Config: `config_unet_se.yaml`
- Hypothesis: SE attention improves structural fidelity.

7. `unet_se_lowlr_r1`
- Script: `hpc/train_job.sbatch`
- Config: `config_unet_se_lowlr.yaml`
...
- Diffusion:
  - `EXPERIMENT_NAME="diff_r1_v1" CONFIG_PATH="diffusion_config_recovery_v1.yaml" sbatch hpc/diffusion_inference_job.sbatch`
  - Optional: `DDIM_STEPS=50 NO_TTA=1`

- U-Net:
  - `EXPERIMENT_NAME="unet_se_r1" CONFIG_PATH="config_unet_se.yaml" sbatch hpc/inference_job.sbatch`
  - Optional: `NO_TTA=1`
